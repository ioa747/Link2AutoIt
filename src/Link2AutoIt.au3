...
Global $sL2A_Blacklist = "|doubleclick.net|google-analytics.com|adnxs.com|"

; --- initialization to ensure Proxy is running ---
Func _L2A_Init()
...
; --- Function to read the entire raw JSON from shared memory ---
Func _L2A_GetRawData()
...
; --- Function to extract a specific field from the JSON string ---
Func _L2A_GetField00($sField)
...
; --- Function to Get, Add, or Remove domains from the Blacklist ---
...
Func _L2A_Blacklist($sDomain, $bState = "")
    ; Static variable stores the list persistently within the function
